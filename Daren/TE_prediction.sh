...
##########################################################################################
# This script will run a task array for Bathycallisoma populations to itteratively mask TE and  collate results
##########################################################################################
...
mkdir -p ${SLURM_ARRAY_TASK_ID}/logs ${SLURM_ARRAY_TASK_ID}/01_simple_out ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out ${SLURM_ARRAY_TASK_ID}/03_known_out ${SLURM_ARRAY_TASK_ID}/04_unknown_out ${SLURM_ARRAY_TASK_ID}/05_full_out
echo Directories generated: ${SLURM_ARRAY_TASK_ID}/logs ${SLURM_ARRAY_TASK_ID}/01_simple_out ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out ${SLURM_ARRAY_TASK_ID}/03_known_out ${SLURM_ARRAY_TASK_ID}/04_unknown_out ${SLURM_ARRAY_TASK_ID}/05_full_out ${SLURM_ARRAY_TASK_ID}/07_ParseRM_landscape
...
RepeatMasker -pa 20 -a -e ncbi -s -dir ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out -nolow -species arthropoda \
        ${SLURM_ARRAY_TASK_ID}/01_simple_out/${SLURM_ARRAY_TASK_ID}_*.simple_mask.masked.fa 2>&1 | tee ${SLURM_ARRAY_TASK_ID}/logs/02_arthropodamask.log

#rename outputs from previous round
# round 2: rename outputs
rename simple_mask.masked.fa arthropoda_mask ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*
rename .masked .masked.fa ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*
...
RepeatMasker -pa 20 -a -e ncbi -dir ${SLURM_ARRAY_TASK_ID}/03_known_out -nolow \
       ...
       ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*.arthropoda_mask.masked.fa 2>&1 | tee ${SLURM_ARRAY_TASK_ID}/logs/03_knownmask_sizeselected.log

#rename outputs from previous round
# round 2: rename outputs
rename  arthropoda_mask.masked.fa known_mask ${SLURM_ARRAY_TASK_ID}/03_known_out/${SLURM_ARRAY_TASK_ID}_*
...
gzip ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*.arthropoda_mask.cat
...
${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*.arthropoda_mask.cat.gz \
...
cat ${SLURM_ARRAY_TASK_ID}/01_simple_out/${SLURM_ARRAY_TASK_ID}_*.simple_mask.out | tail -n +4 \
        <(cat ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*.arthropoda_mask.out | tail -n +4) \
...
cat ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*.arthropoda_mask.out \
        <(cat ${SLURM_ARRAY_TASK_ID}/03_known_out/${SLURM_ARRAY_TASK_ID}_*.known_mask.out | tail -n +4) \
        <(cat ${SLURM_ARRAY_TASK_ID}/04_unknown_out/${SLURM_ARRAY_TASK_ID}_*.unknown_mask.out | tail -n +4) \
...
cat ${SLURM_ARRAY_TASK_ID}/01_simple_out/${SLURM_ARRAY_TASK_ID}_*.simple_mask.align \
        ${SLURM_ARRAY_TASK_ID}/02_arthropoda_out/${SLURM_ARRAY_TASK_ID}_*.arthropoda_mask.align \
...
ProcessRepeats -a -species arthropoda ${SLURM_ARRAY_TASK_ID}/05_full_out/${SLURM_ARRAY_TASK_ID}.full_mask.cat.gz  \
