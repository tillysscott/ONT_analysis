...
###
#set up
export genome="transcriptome_HSP_contigs"
export library="../Hirondellea_PacBio-pdrnd1.ntLink_scaffolds.gxsplit.clean.CURATED_TE_LIBRARY.cdhit_80"
...
RepeatMasker -pa 2 -a -e ncbi -dir 01_simple_out -noint -xsmall ${genome}.fa 2>&1 | tee logs/01_simplemask.log
...
RepeatMasker -pa 2 -a -e ncbi -s -dir 02_arthropoda_out -nolow -species arthropoda \
