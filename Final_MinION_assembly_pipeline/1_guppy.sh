...
# GUPPY
#
# to chose sonfiguration mode (-c) run
...
# default q-score cut off is 8 for DNA fast models, 9 for DNA hac models, 10 for DNA sup models, and 7 for all RNA models
#
#

# modify --kit and --barcode_kits options if required
#
