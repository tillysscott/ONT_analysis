...
###################################################
# kraken2 analysis
## supposed to run on reads, also works on assembled seqs
################################################
...
#
ls ../Tilly186-1/basecall_guppy/pass/*.fastq.gz > 186_input_fq.txt
ls ../Tilly186-2/basecall_guppy/pass/*.fastq.gz >> 186_input_fq.txt
ls ../Tilly186-3/basecall_guppy/pass/*.fastq.gz >> 186_input_fq.txt
ls ../Sue/SP06.pass.fastq.gz >> 186_input_fq.txt
ls ../Sue/SP07.pass.fastq.gz >> 186_input_fq.txt
#
...
export DBNAME="../../../kraken2/DB_standard_kraken2"
export prefix="186-T3S2"
export outdir="."

### 

kraken2 --db $DBNAME --threads 10 $(cat 186_input_fq.txt)\
